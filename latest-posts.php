...
*/
	...
	add_action( 'wp_enqueue_scripts', 'latest_posts_widget_styles' );

	function latest_posts_widget_styles() {
...
add_action( 'widgets_init', create_function('', 'return register_widget("LatestPostsWidget");') );
